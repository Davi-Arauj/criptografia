...
type Req struct {
	Document   *string `json:"documento" binding:"required,stringField,gte=1" minLength:"1" codinome:"documento"`
	CreditCard *string `json:"cartao" binding:"required,stringField,gte=1" minLength:"1" codinome:"cartao"`
	Value      *string `json:"valor" binding:"required,stringField,gte=1" minLength:"1" codinome:"valor"`
}
